...
public class Data {
    ...
    public static List<Student> getStudentsList() {
        ...
        Course course1 = new Course("HTML/CSS для тестировщиков");
        Course course2 = new Course("Java. Уровень 1");
        Course course3 = new Course("Java Core для тестировщиков");
    ...
    private static List<Course> getListCourses() {
        return Arrays.asList(new Course("HTML/CSS для тестировщиков"),
